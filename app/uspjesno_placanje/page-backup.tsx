...
function UspjesnoPageContent() {
  ...
  useEffect(() => {
    if (isProcessed || !isClient) return;
  ...
  }, [session, isProcessed, stavke, resetKorpa, isClient]);
...
// Force dynamic rendering to prevent prerendering issues with searchParams
export const dynamic = 'force-dynamic';

export default function UspjesnoPlacanjePage() {
  return <UspjesnoPageContent />;
}