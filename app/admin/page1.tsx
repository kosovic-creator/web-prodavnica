...
import { porudzbineSchema } from '@/zod';
...
// Delete korisnika
  ...
  const validateForm = () => {
    setFieldErrors({});
    const schema = porudzbineSchema(t);
      ...
      <div className="px-2 bg-gray-50 min-h-screen w-full">
        ...
        {tab === 'korisnici' && (
          <div className="w-full">
            <h2 className="text-2xl font-semibold mb-4">{t('korisnici', { ns: 'korisnici' })}</h2>
